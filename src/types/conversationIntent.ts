export enum ConversationIntent {
  ...
  UNKNOWN = 'UNKNOWN',
  // adress intents
  ONBOARDING_ADDRESS_REQUIRED= 'ONBOARDING_ADDRESS_REQUIRED',
  ONBOARDING_CAPTURE_ADDRESS= 'ONBOARDING_CAPTURE_ADDRESS',
  ONBOARDING_CONFIRM_ADDRESS= 'ONBOARDING_CONFIRM_ADDRESS',
  ONBOARDING_START = 'ONBOARDING_START',
  ONBOARDING_SUBMIT_ADDRESS_TEXT = 'ONBOARDING_SUBMIT_ADDRESS_TEXT',
  ONBOARDING_SUBMIT_ADDRESS = 'ONBOARDING_SUBMIT_ADDRESS',
